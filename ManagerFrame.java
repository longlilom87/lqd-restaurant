...
//		ResultSet rs = stmt.executeQuery();
	...
	public ManagerFrame() throws SQLException {
		...
		lblNewLabel_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
					UpMenu u;
					lblNewLabel_1.setIcon(new ImageIcon (new ImageIcon("Image/drink.png").getImage().getScaledInstance(246,211, java.awt.Image.SCALE_SMOOTH)));
					lblNewLabel_10.setVisible(true);
		...
		lblNewLabel_11.setIcon(new ImageIcon (new ImageIcon("Image/computer.png").getImage().getScaledInstance(106,88, java.awt.Image.SCALE_SMOOTH)));
